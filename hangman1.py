...
def tries(count):
    myfont = pygame.font.SysFont("dokchampa", 20)
...
def game_intro():
    ...
    while intro:
        ...
        largetext = pygame.font.SysFont("freesans", 75)
        font_ob = largetext.render("The last Word.", True, black)
        minitext = pygame.font.SysFont("arial", 30)
        font_ob2 = minitext.render("Developer - Sahil saini", True, black)
        screen.blit(font_ob, (250, 0))
        screen.blit(font_ob2, (0, 680))
        intro_button("PLAY", 350, 560, 80, 40, green, bright_green, "PLAY")
        intro_button("QUIT", 600, 560, 80, 40, red, bright_red, "QUIT")
        pygame.display.flip()
        clock.tick(100)
...
def game_loop():
    while not running:
        ...
        if movie == ("".join(list)):
            ...
            largetext2 = pygame.font.SysFont("comicsnasms", 50)
            font_ob1 = largetext.render("You won!", True, bright_green)
            font_ob2 = largetext2.render("The movie was:", True, orange)
            font_ob3 = largetext2.render(movie, True, orange)
...
pygame.init() #this is for the screen 
display_width = 1050
display_height = 720
...
pygame.display.set_caption('Hangman(by sahil saini)1.0')
running = False
